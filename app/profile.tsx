        ...
        <div className="container mx-auto flex flex-col items-center md:flex-row md:items-start gap-6">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="mt-4 max-w-[500px]">
              ...
              building scalable and efficient web applications. I have a strong
              background in JavaScript, React, and Node.js, and I&apos;m always
        ...
        <div className="container mx-auto space-y-12">
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-gray-500 dark:text-gray-400">
                  Jan/2023 – March/2023 | CDCFE IT Department (Coolock, Dublin)
                </p>
                <p className="mt-2">
                  Developed and maintained complex web applications using React,
                  Node.js, and various other technologies. Collaborated with
                  cross-functional team to deliver high-quality web solutions.
                </p>
              </div>
              <div>
                <h3 className="text-xl font-semibold">Full Stack Developer</h3>
                <p className="text-gray-500 dark:text-gray-400">
                  Jan/2021 – Present | avanzo.io
                </p>
                <p className="mt-2">
                  Co-Founder and responsible for building and optimizing the
                  end-to-end architecture of blockchain application. Worked
                  closely with designers, front-end, and back-end developers to
                  ensure seamless integration and a great user experience.
                </p>
              </div>
            </div>
          </section>
          <section id="education">
            ...
            <div className="space-y-8">
              <div>
                <h3 className="text-xl font-semibold">
                  Bachelor Science in Computing, QQI BSc (Honours) Degree
                </h3>
                <p className="text-gray-500 dark:text-gray-400">
                  2023 – Present | National College of Ireland, Dublin
                </p>
              </div>
              <div>
                <h3 className="text-xl font-semibold">
          ...
          <section id="additional-info">
            ...
            <div className="space-y-8">
              <div>
                ...
                <ul className="mt-2 space-y-1 text-gray-500 dark:text-gray-400">
                  <li>
                    2022 – 2023 | Coláiste Dhúlaigh College, Dublin.
                    Qualification: QQI 6 Higher Advanced Certificate in Computer
                    Science
                  </li>
                  <li>
                    2021 – 2022 | Coláiste Dhúlaigh College, Dublin.
                    Qualification: QQI 5 Certificate in Computer Science
                  </li>
                </ul>
              </div>
              <div>
                ...
                <p className="mt-2 text-gray-500 dark:text-gray-400">
                  In my free time, I enjoy hiking, reading, and learning about
                  new technologies. I also make videos on TikTok{" "}
                  <a href="https://www.tiktok.com/@itiscoded?lang=en">
                    itiscoded
                  </a>
                </p>
              </div>
